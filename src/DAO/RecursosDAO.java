...
public class RecursosDAO {
    ...
    public Recurso buscaRecurso(String chaveBusca){
        Recurso recursoResult = new Recurso();
        String sql = "SELECT recurso_nome, recurso_email, recurso_projeto FROM public.recurso WHERE recurso_email=?;";
        ...
        try {
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                recursoResult.setRecursoNome(resultSet.getString("recurso_nome"));
                recursoResult.setRecursoEmail(resultSet.getString("recurso_email"));
                recursoResult.setRecursoProjeto(resultSet.getString("recurso_projeto"));
            }
